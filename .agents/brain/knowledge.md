...
6. **OS Family Declarations & Sockets:** The documentation and pages officially declare support for both the Debian-derived (Ubuntu 24.06 LTS, Ubuntu 26.04 LTS, Debian 11, Debian 12) and RHEL-derived (RHEL 9, RHEL 10, AlmaLinux 9, AlmaLinux 10, Rocky Linux 9 & 10, Oracle Linux 9 & 10) Linux families, specifying socket locations and configuration structures for each.
