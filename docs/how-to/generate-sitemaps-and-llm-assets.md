...
Both sitemap generation and LLM asset compilers are automatically verified inside our GitHub Actions workflows (`.github/workflows/jekyll-gh-pages.yml` and `.github/workflows/docs-ci.yml`).
