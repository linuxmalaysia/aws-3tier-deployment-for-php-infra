...
For a representative 15-node production cluster, the fully consolidated steady-state CloudWatch observability stack (RUM, Application Signals APM, host metrics with 4 to 12 custom metrics/node, native service metrics, alarms/dashboards) is estimated at **$56.00 – $300.00 USD per month (~RM 252.00 – RM 1,350.00 MYR)** post-trial, based on a reproducible workload model (250k–1M web sessions @ 10–20 RUM events/session = 2.5M–20M events = $25–$200; 5M–20M Application Signals Golden Metrics = $7.50–$30; 10–40 GB optional transaction traces = $3.50–$14; 15 EC2 instances @ 4–12 custom metrics/node across 1–2 network interfaces = 60–180 series = $15–$51; composite alarms = $5.00). Compared to legacy Dynatrace Full-Stack Monitoring estimated at **$870.00 – $1,110.00+ USD per month (~RM 3,915.00 – RM 4,995.00+ MYR)** for 15 host units ($58–$74/host unit/month), this migration yields potential recurring operational savings of **~$570.00 – $1,054.00 USD per month (~RM 2,565.00 – RM 4,743.00 MYR per month)** while eliminating third-party SaaS egress and reclaiming host compute capacity.
...
| **15-Host Cluster Monthly Cost** | **$870.00 – $1,110.00+ USD** (~RM 3,915 – RM 4,995 MYR) | **$56.00 – $300.00 USD** (~RM 252.00 – RM 1,350.00 MYR) | **65% to 90% direct monthly cost reduction** based on reproducible workload model |
...
| **Total CloudWatch Suite** | **Full-Stack AWS-Native Observability Envelope** | **~$56.00 – $300.00** | **~RM 252.00 – RM 1,350.00** |
| **Legacy Dynatrace OneAgent** | **15 Host Units @ $58–$74/HU/month** | **~$870.00 – $1,110.00+** | **~RM 3,915.00 – RM 4,995.00+** |

**Net Strategic Impact:** Transitioning to native CloudWatch observability delivers full APM and end-user visibility inside **AWS Malaysia (`ap-southeast-5`)** with an immediate recurring operational saving of **~$570.00 to $1,054.00 USD per month (~RM 2,565.00 to RM 4,743.00 MYR per month)**.
