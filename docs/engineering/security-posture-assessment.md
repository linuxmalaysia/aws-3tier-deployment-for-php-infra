...
| 2 | External Penetration Test | Vulnerabilities on public-facing domains/IPs (apps, source code, HTTP) | **1 public URL**<br><br>`pbtpay.kpkt.gov.my` / `secure-app.enterprise.gov.my` |
