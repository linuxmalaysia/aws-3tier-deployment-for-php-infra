...
* **Identified Exceptions / Deviations:**
  - Compute ASG egress is left unrestricted to support automated software updates and secure package downloads via official OS mirrors (Debian/RHEL package repositories), guarded by NAT Gateways.
