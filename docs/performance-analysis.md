...
| **2,500 VU** | High-Performance Prod | **$1,264.56 USD** | **FAIL (Bottleneck)** | RDS MariaDB Query CPU & PostgreSQL storage write sync | [2,500 VU Sizing Specs](performance-testing.html#2500-vu--high-performance-production-model-high-concurrency) |
