...
title: "Legal Notice, Critical Assumptions & Disclaimer of Liability"
timestamp: 2026-08-11T12:00:00+08:00
topics: ["aws", "3-tier", "legal", "disclaimer"]
---
...
This project, including its architectural designs, playbooks, scripts, configuration templates, OpenTofu modules, and associated documentation, is created strictly for training, educational, and planning proposal purposes only. It serves as an open learning reference and laboratory simulation for modern secure multi-AZ deployment patterns.
...
* **Cost Estimations:** Any and all financial calculations, resource costs, licensing designs, and hardware budgets are based entirely on assumptions and standard baseline estimations.
...
* **Disclaimer:** We are not going to be responsible or liable for any service interruptions, system crashes, security incidents, loss of data, or any other damages arising from the implementation or adaptation of these materials.
...
## Table of Contents
* [1. Educational and Training Purpose](#1-educational-and-training-purpose)
* [2. Reliance on Critical Assumptions](#2-reliance-on-critical-assumptions)
* [3. Privacy Statement & Data Protection](#3-privacy-statement--data-protection)
* [4. Assumption of Risk & Liability Disclaimer](#4-assumption-of-risk--liability-disclaimer)
...
Copyright &copy; 2005 - 2026 Harisfazillah Jamel
